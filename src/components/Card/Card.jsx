...
const Card = ({ imagePath, title, description, actionArrow, height, width }) => {
    return (
        <div className="flex flex-col p-6">
            <img className={`h-[${height ? height : '260px'}] w-[${width ? width : '240px'}] object-cover object-center
            border hover:scale-105 cursor-pointer rounded-lg `} src={imagePath} alt={title} />
